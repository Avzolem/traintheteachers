...
const features = [
  {
    name: "Mejora tu conocimiento en tecnología.",
    description:
      "Lorem ipsum, dolor sit amet consectetur adipisicing elit aute id magna.",
    icon: CpuChipIcon,
  },
  {
    name: "Implementación de mejores herramientas.",
    description:
      "Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo.",
    icon: WrenchScrewdriverIcon,
  },
  {
    name: "Mejora tus clases.",
    description:
            ...
            <div className="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
              <figure className="relative isolate pt-6 sm:pt-12">
                ...
                <blockquote className="text-xl font-semibold leading-8 text-white sm:text-2xl sm:leading-9">
                  <p>
                    Aquí va algún mensaje de un maestro o maestra que haya
                    tomado un curso y esté bien feliz de haberlo hecho. Porque
                    es lo mejor que le ha pasado en la vida.
                  </p>
                </blockquote>
                <figcaption className="mt-8 text-base">
                  <div className="font-semibold text-white">Ximena Machado</div>
